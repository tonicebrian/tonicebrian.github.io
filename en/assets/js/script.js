...
$(document).ready(function () {
    $(".portfolio-project-video-wrap").fitVids();
})
...
window.onload = function () {
    ...
    var latlng = new google.maps.LatLng(40.827384, -73.904607);
    ...
    var markerPosition = new google.maps.LatLng(40.827384, -73.904607);

    var markerImage = '../assets/img/others/marker.png';
...
$(function () { $('#portfolio-grid-wrap').mixitup(); });
$('body').on('click', '.grid-filter li', function () {
